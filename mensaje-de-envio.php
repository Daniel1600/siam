                  	...
                  	<div class="row">
	                  	<div class="col-md-12">
                             ...
                             <div class="contenedor">
                              <h3 class="mensaje">EL Vehículo se ha programado exitosamente</h3>
                              <p><a href="modulos/Diagnosticovehiculo/programacionMantenimiento.php" class="otro">Programar otro vehículo</a></p>
                            </div>
		                          <!--Fin Contenido-->
                           </div>
                        </div>
